...
export default function Content({ setItemDetails, itemDetails }) {
  ...
  return (
    <div className="con-page pb-5"><br/><br/>
        <div
      ...
      <div className="container">
        <h1 className="category"><span className="category-head">women's</span> clothing</h1>
        <div className="row cate container">
          {products &&
            products.map((data, i) => {
              if (data.category === "women's clothing") {
                return (
                  <div className="card col-xl-2 col-md-4 col-sm-6">
                    <img
                      alt="example"
                      src={data.image}
        ...
        <h1 className="category"><span className="category-head">Electronics</span></h1>
        <div className="row cate container">
          {products &&
            products.map((data, i) => {
              if (data.category === "electronics") {
                return (
                  ...
                  >
                    ...
                    <h3 className="rate">
                      ${data.price}
                      <span className="rateOff">30%off</span>
                    </h3>
                    <button
                      className="cartBtn"
                      data-bs-toggle="modal"
        ...
        <h1 className="category"><span className="category-head">Jewelery</span></h1>
        <div className="row cate container">
          {products &&
            products.map((data, i) => {
              if (data.category === "jewelery") {
                return (
                  ...
                  >
                    ...
                    <h3 className="rate">
                      ${data.price}
                      <span className="rateOff">15%off</span>
                    </h3>
                    <button
                      className="cartBtn"
                      data-bs-toggle="modal"
        ...
        <h1 className="category"><span className="category-head">Men's</span> clothing</h1>
        <div className="row cate container">
          {products &&
            products.map((data, i) => {
              if (data.category === "men's clothing") {
                return (
                  ...
                  >
                    ...
                    <h3 className="rate">
                      ${data.price}
                      <span className="rateOff">50%off</span>
                    </h3>
                    <button
                      className="cartBtn"
                      onClick={() => {
      ...
      <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-body text-center pt-0 pb-0" style={{justifyContent:"space-between", display:'flex'}}>
